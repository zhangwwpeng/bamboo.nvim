...
hl.common = {
  ...
  FoldColumn = { fg = c.de_purple , bg = de_bg1 },
  Folded = { fg = c.de_purple, bg = c.de_bg1 },
  SignColumn = { fg = c.fg },
  ToolbarLine = { fg = c.none , bg = c.de_bg2 },
  Cursor = { fg = de_bg0 , bg = de_bg_yellow },
  lCursor = { fg = de_bg0 , bg = de_red },
