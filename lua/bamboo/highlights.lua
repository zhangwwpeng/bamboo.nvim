...
local colors = {
    Fg = { fg = c.de_fg },
    LightGrey = { fg = c.de_light_grey },
    Grey = { fg = c.de_grey },
    Red = { fg = c.de_red },
    Cyan = { fg = c.de_cyan },
    Yellow = { fg = c.de_yellow },
    Orange = { fg = c.de_orange },
    Green = { fg = c.de_green },
    Blue = { fg = c.de_blue },
    Purple = { fg = c.de_purple },
}
...
hl.common = {
    Normal = { fg = c.de_fg, bg = c.de_bg0 },
    NormalNC = { link = 'Normal' },
    NormalFloat = { fg = c.de_fg, bg = c.de_bg0 },
    FloatBorder = { fg = c.de_blue, bg = c.de_bg0 },
    FloatTitle = colors.Red,
    FloatFooter = colors.LightGrey,
    Terminal = { link = 'Normal' },
    EndOfBuffer = { bg = c.de_bg1 },
    FoldColumn = { fg = c.de_purple, bg = c.de_bg1 },
    Folded = { fg = c.de_purple, bg = c.de_bg1 },
    SignColumn = { fg = c.de_fg },
    ToolbarLine = { fg = c.none, bg = c.de_bg2 },
    Cursor = { fg = c.de_bg0, bg = c.de_bg_yellow },
    lCursor = { fg = c.de_bg0, bg = c.de_red },
    CursorIM = { link = 'Cursor' },
    CursorColumn = { link = 'CursorLine' },
    CursorLine = { fg = c.none, bg = c.de_bg2 },
    ColorColumn = { fg = c.de_fg, bg = c.de_orange },
    CursorLineNr = { fg = c.de_purple },
    LineNr = { fg = c.de_purple, bg = c.none },
    Conceal = colors.de_bg2,
    ...
    Directory = { fg = c.de_blue },
    ErrorMsg = { fg = c.de_red, bold = true },
    WarningMsg = { fg = c.de_yellow, bold = true },
    MoreMsg = { fg = c.de_blue, bold = true },
    CurSearch = { link = 'Search' },
    IncSearch = { fg = c.de_yellow, bg = c.de_orange },
    Search = { fg = c.de_bg_yellow, bg = c.de_grey },
    Substitute = { fg = c.de_bg0, bg = c.de_green },
    MatchParen = { fg = c.de_bg3, bg = c.de_bg5, bold = true },
    ModeMsg = { fg = rainbows.cyan, bold = true },
    NonText = { fg = c.de_bg3, bg = c.none },
    Whitespace = { link = 'NonText' },
    SpecialKey = { link = 'NonText' },
    Pmenu = { fg = c.de_fg, bg = c.de_bg2 },
    PmenuSbar = { fg = c.none, bg = c.de_bg0 },
    PmenuSel = { fg = c.de_bg0, bg = c.de_yellow },
    WildMenu = { fg = c.de_bg0, bg = c.de_purple },
    PmenuThumb = { fg = c.none, bg = c.de_light_grey },
    PmenuMatch = { fg = c.de_cyan, bg = c.de_bg2 },
    PmenuMatchSel = { fg = c.de_light_grey, bg = c.de_yellow },
    Question = { fg = c.de_green },
    SpellBad = { fg = c.de_orange, undercurl = true, sp = c.de_orange },
    SpellCap = { fg = c.de_bg_blue, undercurl = true, sp = c.de_bg_blue },
    SpellLocal = { fg = c.de_blue, undercurl = true, sp = c.de_blue },
    SpellRare = { fg = c.none, undercurl = true, sp = c.de_purple },
    StatusLine = { fg = c.de_bg0, bg = c.de_light_grey },
    StatusLineNC = { fg = c.de_grey, bg = c.de_light_grey },
    StatusLineTerm = { fg = c.de_bg0, bg = c.de_light_grey },
    StatusLineTermNC = { fg = c.de_fg, bg = c.de_light_grey },
    TabLine = { fg = c.de_bg0, bg = c.de_light_grey },
    TabLineFill = { fg = c.none, bg = c.de_light_grey },
    TabLineSel = { fg = c.de_bg0, bg = c.de_yellow },
    VjrtSplit = { fg = c.none, bg = c.de_light_grey },
    Title = { fg = c.de_orange, bold = true },
    Visual = { fg = c.none, bg = c.de_bg4 },
    VisualNOS = { fg = c.none, bg = c.de_bg4, underline = true },
    WinSeparator = { fg = c.de_light_grey, bg = c.de_bg0 },
    WinBar = colors.LightGrey,
    WinBarNC = { link = 'WinBar' },
    QuickFixLine = { fg = c.de_bg0, bg = c.de_yellow, underline = true },
    Debug = { fg = c.de_orange },
    debugPC = { fg = c.de_bg2, bg = c.none },
    debugBreakpoint = { fg = c.de_cyan, bg = c.none },
    ToolbarButton = { fg = c.de_bg0, bg = c.de_bright_purple },
