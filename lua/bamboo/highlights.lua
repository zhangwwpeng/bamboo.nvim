...
hl.common = {
  ...
  NormalFloat = { fg = c.de_fg, bg = c.de_bg2 },
  FloatBorder = { fg = c.de_grey, bg = c.de_light_grey },
  ...
  NonText = { fg = c.de_blue, bg = c.de_bg1 },
  ...
  VjrtSplit = { fg = c.de_grey, bg = c.de_light_grey },
  Title = { fg = c.de_orange, bold = true },
  Visual = { fg = c.de_bg_yellow, bg = c.de_bg4 },
  VisualNOS = { fg = c.de_yellow, bg = c.de_blue, underline = true },
  WinSeparator = { fg = c.de_grey, bg = c.de_light_grey },
